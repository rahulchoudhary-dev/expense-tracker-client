    ...
    <div className="backdrop-blur-lg bg-white/80 rounded-3xl shadow-2xl p-8 md:p-12 border border-white/30 transform transition-all duration-500 hover:scale-[1.02] hover:shadow-3xl">
      <form onSubmit={formik.handleSubmit} className="space-y-8">
        ...
        <div className="space-y-3 group">
          <label className="flex items-center text-lg font-semibold text-gray-800 group-hover:text-purple-600 transition-colors duration-200">
            <svg
          ...
          <div className="relative">
            <InputFiled
              ...
              className="w-full text-lg px-5 py-4 rounded-2xl border-2 border-gray-200 focus:border-purple-500 focus:ring-4 focus:ring-purple-200 transition-all duration-300 bg-white/70 backdrop-blur-sm placeholder-gray-400"
            />
          </div>
        </div>
        ...
        <div className="space-y-3 group">
          ...
          <div className="relative">
            <div className="space-y-2">
              ...
              >
                <SelectTrigger
                  className={`w-full cursor-pointer px-5 py-8 border-2 rounded-2xl focus:ring-4 focus:ring-purple-200 focus:border-purple-500 transition-all duration-300 appearance-none bg-white/70 backdrop-blur-sm text-lg font-medium ${
        ...
        <div className="space-y-3 group">
          <label className="flex items-center text-lg font-semibold text-gray-800 group-hover:text-purple-600 transition-colors duration-200">
            <Calendar1Icon className="w-5 h-5 mr-2 text-purple-500" />
        ...
        <div className="space-y-3 group">
          ...
          <div className="relative">
            ...
            <InputFiled
              ...
              onChange={formik.handleChange}
              placeholder="0.00"
              className="w-full text-lg pl-12 pr-5 py-4 rounded-2xl border-2 border-gray-200 focus:border-purple-500 focus:ring-4 focus:ring-purple-200 transition-all duration-300 bg-white/70 backdrop-blur-sm placeholder-gray-400"
            />
          </div>
        </div>
